...
$_lang['prop_register.usergroupsfieldallow_desc'] = 'Optional. A comma-separated list of User Group names or IDs the newly-registered User can be added to. Only used if this value is not blank.';
